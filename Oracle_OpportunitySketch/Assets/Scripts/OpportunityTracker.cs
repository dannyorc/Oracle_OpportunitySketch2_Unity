...
/// 	- how many sub-opps it has (customers, workers, admin, hr, ... so on)
/// 	- how many circle charts and how many square charts
///		- how many sticky notes and each one's information (transform, text, color, used/not used, value, which chart they're under)
/// 	- how many mad libs we have and each one's current filled in info
